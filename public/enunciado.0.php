...
<imput type="number" id="filainicio" name=filainicio min="0" max="6"><br>
<label for="columnainicio">columna inicio</label>
<imput type="number" id="columnainicio" name=columnainicio min="0" max="6"><br>
<label for="filafin">fila fin</label>
<imput type="number" id="filafin" name=filafin min="0" max="6"><br>
<label for="columnafin">columna fin</label>
<imput type="number" id="columnafin" name=columnafin min="0" max="6"><br>
   ...
   generarTablero($numeros, $colores);
    ...
    function tiradaValida($combinaciones){
        if ($_SERVER['REQUEST_METHOD'] == 'POST'){
            $filainicio=isset($_POST['filainicio'])? (int)$_POST['filainicio']=0s
            $columnainicio=isset($_POST['columnainicio'])?(int)$_POST['columnainicio']=0
            $filafin=isset($_POST['filafin'])?(int)$_POST['filafin']=0
            $columnafin=isset($_POST['columnafin'])?(int)$_POST['columnafin']=0
        }
