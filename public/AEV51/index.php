...
function dañosTotales(&$mapa, $impactos){
    ...
    foreach ($mapa as $valor){
        ...
        $dañosTotales = $dañosUr + $dañosNoUrbanos ;
    }
} 
...
$pescadoKm= 2000 / $marTotal;
$pescadoTotal= ($pescadoKm * $marAfec);
...
$resultventas= round($ventas, 0);
}
echo "VENTAS <br>";
echo "Podriamos ganar $resultventas € vendiendo pescado" ;
}
